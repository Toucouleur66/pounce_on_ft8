...
<context>
    ...
    <message>
        ...
        <translation>&lt;p&gt;同じ期間に複数の局がデコードされたとき、どの局に応答するかを決めるための順序を設定します。行をドラッグアンドドロップして並べ替えます。一番上の行が最も優先度が高くなります。&lt;/p&gt;&lt;p&gt;&lt;b&gt;除外コールサイン&lt;/b&gt;および&lt;b&gt;除外ゾーン&lt;/b&gt;の行はしきい値として機能します。除外行より&lt;b&gt;上&lt;/b&gt;に置かれたターゲットは、除外があっても引き続き呼び出されますが、除外行より&lt;b&gt;下&lt;/b&gt;に置かれたターゲットはブロックされます。すべてをブロックするには除外行を一番上に置き、特定のターゲットを通すにはそのターゲットの下に置いてください。&lt;/p&gt;</translation>
    </message>
    <message>
