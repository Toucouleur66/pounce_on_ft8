...
CURRENT_VERSION_NUMBER          = "2.32"
EXPIRATION_DATE                 = datetime(2027, 8, 15)
...
DEFAULT_WATCHDOG_NUMBER_OF_ATTEMPTS = 10
DEFAULT_WATCHDOG_RETRY_TIME         = 20 # minutes
...
DEFAULT_MAX_REPLY_CALLSIGN_LENGTH   = 11 # max number of characters in a callsign we may reply to (7..13)
MIN_MAX_REPLY_CALLSIGN_LENGTH       = 7
MAX_MAX_REPLY_CALLSIGN_LENGTH       = 13
...
DEFAULT_ENABLE_PSTROTATOR_WANTED    = False
DEFAULT_ENABLE_PSTROTATOR_SCHEDULE  = False
