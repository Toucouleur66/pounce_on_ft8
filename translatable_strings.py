...
class SettingsStrings:
    ...
    CLUB_LOG_NOTICE = lambda: tr("SettingsDialog",
        "<p>Club Log is a web service for amateur radio logging and statistics.</p><p>You can enable automatic upload of your QSO data to Club Log.</p><p>Use your registered email and ClubLog's password OR an Application Password (create the Application Password in your Club Log account settings).</p>"
    )
    ...
    LABEL_PASSWORD = lambda: tr("SettingsDialog", "Password or Application Password:")
    ...
    GROUP_PSTROTATOR_BANDS = lambda: tr("SettingsDialog", "Enable for bands")
